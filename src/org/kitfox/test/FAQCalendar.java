...
public class FAQCalendar extends GregorianCalendar {
     ...
     * 
     */
    private static final long serialVersionUID = -346400320900833166L;
    ...
    /****
     * Value to add to the day number returned by this calendar to find the Julian Day number. This is the Julian Day number for 1/1/1970. Note: Since the unix
     * Day number is the same from local midnight to local midnight adding JULIAN_DAY_OFFSET to that value results in the chronologist, historians, or
     * calenderists Julian Day number.
     * 
    ...
    /**
     * find the number of days from this date to the given end date. later end dates result in positive values. Note this is not the same as subtracting day
     * numbers. Just after midnight subtracted from just before midnight is 0 days for this method while subtracting day numbers would yields 1 day.
     * 
     * @param end
    ...
    /**
     * DO NOT USE THIS Method it does not work across daylight savings boundaries for all difference intervals which include a day which has lost an hour and is
     * only 23 hours long.
     * 
     * @param end
     *            - any Calendar representing the moment of time at the end of the interval for calculation.
